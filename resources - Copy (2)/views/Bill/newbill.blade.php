        ...
        <div class="card card-info">
          <div class="card-body">
           ...
           <div class="form-group row">
             <input autofocus="on" maxlength="15" type="text" class="form-control number" name="mobile" id="cus_mobile" placeholder="Mobile">
			 <button style="position: absolute;right: 0;height: 33px;" data-toggle="modal" data-target="#addCustomer" type="buttom" class="btn btn-danger ">+</button>

           </div> 
		   
 <div class="search-results" style="position: absolute; z-index: 1000; background: #fff; width: 100%;"></div>
         ...
         <div class="form-group row">
           <input maxlength="5" onkeypress="return runScript2(event)" onkeyup="calculate_amount()"  required="required" type="text" class="form-control decimal"  name="product_qty" id="quantity" placeholder="Quantity">
         </div>
