...
<div class="content-wrapper">
    <section class="content">
        <div class="card card-primary card-outline card-outline-tabs">
            <div class="card-body">
                <form action="{{url('/pharmacy/add_category')}}" method="post">
                    {{ csrf_field() }}
                    ...
                    <tr id="arrayorder_<?php echo $manageCategory->id?>">
                        <td>{{ $key + 1 }}</td>
                        <td>{{ $manageCategory->category_name }}</td>
                        @if($manageCategory->status == 0)
