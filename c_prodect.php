          ...
          success: function (category) {
            ...
            for (var i = 0; i < category.length; i++){
              var obj = category[i];
                html+='<div class="product-layout product-list col-xs-12">';
				html+='<div class="product-thumb transition">';
				html+='<div class="image"><a href="category-product.php?id='+obj["category_id"]+'"><img width="100" height=100" src="https://vskbrothers.com/image/'+obj["image"]+'" alt="'+obj["name"]+'" title="'+obj["name"]+'" class="img-responsive center-block" /></a></div>';
				html+='<div class="caption text-center">';
				html+='<h4><a href="category-product.php?id='+obj["category_id"]+'">'+obj["name"]+'</a></h4>';
				html+='</div>';
				html+='</div>';
				html+='</div>';
            }
