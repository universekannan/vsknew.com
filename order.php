...
var customer_id = localStorage.getItem('customer_id');
    ...
    $.ajax({
        ...
        success: function (response) {
          ...
          alert("Your order id is "+response["ocorderid"]);
		  var oc_order_id = response["ocorderid"];
		  //alert(oc_order_id);
		  //e.preventDefault();
          window.location.href = "payments/pandapay.php?name="+firstname+"&userid="+customer_id+"&phone="+telephone+"&by_amount=1&oc_order_id="+oc_order_id;
        },
