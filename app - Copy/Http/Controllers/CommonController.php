...
class CommonController extends BaseController
{
    ...
    /******   Domain Request  Start ******/
        ...
        public function domainRequest(){
            ...
            $developerRole = DB::table('users')->join('user_types','user_types.user_type_id','=','users.role_id')->where('user_types.user_type_id',6)->orderBy('users.id','DESC')->get();
    ...
    /******   AJAX Notification Count  Start ******/
        ...
        //     $content = "";
        //     $permission = DB::table('user_permission')->where('user_type_id',auth()->user()->id)->first();
