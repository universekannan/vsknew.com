...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    ...
    <div class="card-body">
      ...
      <form action="<?php echo e(url('/checkLogin')); ?>" method="post" enctype="multipart/form-data"> 
...
<?php /**PATH C:\xampp\htdocs\vsknew.com\resources\views/login.blade.php ENDPATH**/ ?>