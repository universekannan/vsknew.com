    ...
    <div class="page-content-wrapper">
      ...
      <div class="hero-wrapper">
        <div class="container">
          <div class="pt-3">
            <!-- Hero Slides-->
            <div class="hero-slides owl-carousel" id="banner_image">
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="product-catagories-wrapper py-3">
        <div class="container">
          <div class="row g-2 rtl-flex-d-row-r">
            <!-- Catagory Card -->
            <div class="col-3">
              <div class="card catagory-card" id="accordion_category" >
              </div>
            </div>
            <!--
            <div class="col-3">
      ...
      <div class="flash-sale-wrapper">
        <div class="container">
          <div class="section-heading d-flex align-items-center justify-content-between rtl-flex-d-row-r">
            <h6 class="d-flex align-items-center rtl-flex-d-row-r"><i class="fa-solid fa-bolt-lightning me-1 text-danger lni-flashing-effect"></i>Cyclone Offer</h6>
...
function load_banner(){
    ...
    $.ajax({
      url: "http://localhost/vskbrothers.com/api/homepage-banner.php",
      type: "GET",
    ...
    for (var i = 0; i < products.length; i++){
        var obj = products[i];
        $('<img>', { src: 'https://vskbrothers.com/image/'+obj.image+' }).appendTo(".owl-carousel");
    }
	console.log(html);
...
<script type="text/javascript">
  ...
  function load_category(){
    $.ajax({
          url: "http://localhost/vskbrothers.com/api/parentcategories.php",
          type: "get",
          success: function (category) {
            ...
            html += '<div class="col-3">';
              html += '<div class="card catagory-card">';
                html += '<div class="card-body px-2"><a href="category-product.php?id='+obj["category_id"]+'"><img src="img/core-img/woman-clothes.png" alt=""><span>'+obj["name"]+'</span></a></div>';
              html += '</div>';';
            html += '</div>';
            }
